...
public class MountainCarViewer extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		g2d.drawLine(getXFor(MountainCar.GOAL_POS), getYFor(MountainCar.GOAL_POS), getXFor(MountainCar.GOAL_POS),
				getYFor(MountainCar.GOAL_POS) - 50);
		...
		g2d.drawLine(10, getYFor(MountainCar.MIN_POS) - 40, 10, getYFor(MountainCar.MIN_POS) + 15);
	}
}
